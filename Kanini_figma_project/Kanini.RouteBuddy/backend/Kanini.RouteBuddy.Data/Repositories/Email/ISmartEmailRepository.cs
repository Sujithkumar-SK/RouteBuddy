...
public interface ISmartEmailRepository
{
...
public class ConnectingBookingEmailData
{
    ...
    public List<ConnectingSegmentEmailData> Segments { get; set; } = new();
}

public class ConnectingSegmentEmailData
{
    ...
    public List<ConnectingPassengerEmailData> Passengers { get; set; } = new();
}

public class ConnectingPassengerEmailData
{
