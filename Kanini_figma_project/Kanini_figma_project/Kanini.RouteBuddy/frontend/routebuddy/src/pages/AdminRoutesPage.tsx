        ...
        <Card>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            <Tabs value={tabValue} onChange={handleTabChange}>
              <Tab label="Overview" />
              <Tab label={`All Routes (${routes.length})`} />
            </Tabs>
          </Box>
                  ...
                  <TableBody>
                    {routeData.map((route, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell align="right">{route.totalBookings}</TableCell>
                        <TableCell align="right">{route.confirmedBookings}</TableCell>
                        <TableCell align="right">{route.cancelledBookings}</TableCell>
                        <TableCell align="right">₹{route.totalRevenue.toLocaleString()}</TableCell>
                        <TableCell align="right">{route.successRate}%</TableCell>
