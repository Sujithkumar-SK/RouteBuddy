...
{
  public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<BookingSegment> builder)
  {
    builder.HasOne(bs => bs.Booking)
          .WithMany(b => b.Segments)
          .HasForeignKey(bs => bs.BookingId);

    builder.HasOne(bs => bs.Schedule)
        .WithMany(s => s.Segments)
        .HasForeignKey(bs => bs.ScheduleId)
        .OnDelete(DeleteBehavior.Restrict);

    builder.HasMany(bs => bs.BookedSeats)
